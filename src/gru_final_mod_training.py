...
optimizer = torch.optim.Adam(mod.parameters(), lr=0.0004052184562956591)
...
torch.save(mod.state_dict(), os.path.join(SCRATCH_PATH, 'gru_state.pt'))

# #!/bin/bash
# #SBATCH --job-name=gru_final
# #SBATCH --output=/scratch/%u/gru_%j.out
# #SBATCH --error=/scratch/%u/gru_%j.err
# #SBATCH --account=stat
...
# srun python /u/bleidig2/gru_final_mod_training.py